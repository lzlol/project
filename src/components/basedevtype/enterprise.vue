<template>
	<div>
		...
		<div style="text-align: left;margin:0 0 20px 50px;">
			<el-input style='width:160px' placeholder='设备名称' v-model='typename'></el-input>
			<el-button @click='search'>查询</el-button>
			<el-button @click='add'>添加</el-button>
		</div>
		<center>
			<el-table :data="list">
				<el-table-column prop="typeid" label="ID" width="400"></el-table-column>
				<el-table-column prop="typename" label="设备名称" width="500"></el-table-column>
...
<script>
	export default {
		...
		methods:{
			update(row){
				// 跳转
				this.$router.push({name:'enterpriseedit',params:{row:row}})
			},
			add(){
				// 路由跳转
