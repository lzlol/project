<template>
	<div>
		...
		<div style="text-align: left;margin:0 0 20px 50px;">
			...
			<el-button @click='add'>添加折标煤系数</el-button>
		</div>
		<center>
			<el-table :data="list">
				<el-table-column prop="sid" label="ID" width="150"></el-table-column>
				<el-table-column prop="energetype" label="能源类别"  width="150"></el-table-column>
				<el-table-column prop="ratio" label="系数" width="150"></el-table-column>
