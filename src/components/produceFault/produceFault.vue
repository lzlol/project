<template>
	<div>
		...
		<div style="text-align: left;margin:0 0 20px 50px;">
			<el-input style='width:160px' placeholder='请输入报告人' v-model='faultuser'></el-input>
			<el-button @click='search'>查询</el-button>
			<el-button @click='add'>添加故障信息</el-button>
		</div>
		<center>
			<el-table :data="list">
				<el-table-column prop="faultId" label="ID" width="150"></el-table-column>
				<el-table-column prop="devname" label="设备名称"  width="150"></el-table-column>
				<el-table-column prop="cause" label="故障原因" width="150"></el-table-column>
				<el-table-column prop="faultuser" label="报告人" width="150"></el-table-column>
				<el-table-column prop="faulttime" label="故障时间(分钟)" width="150"></el-table-column>
